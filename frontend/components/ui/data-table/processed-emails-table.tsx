...
interface ProcessedEmailsTableProps {
	initialData: { data: ProcessedData[]; total: number };
}

export function Table({ initialData }: ProcessedEmailsTableProps) {
	const [selectedEmail, setSelectedEmail] = useState<ProcessedData | null>(
		null,
	);
	const [dialogOpen, setDialogOpen] = useState(false);
	const [rowAction, setRowAction] =
		useState<DataTableRowAction<ProcessedData> | null>(null);
	const [data, setData] = useState<ProcessedData[]>(initialData.data);
