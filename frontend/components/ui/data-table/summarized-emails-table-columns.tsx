...
interface GetSummarizedEmailTableColumnsProps {
	setRowAction: (action: DataTableRowAction<AnalysisResult> | null) => void;
	onViewDetails: (email: AnalysisResult) => void;
}

export function getSummarizedEmailTableColumns({
	setRowAction,
	onViewDetails,
}: GetSummarizedEmailTableColumnsProps): ColumnDef<AnalysisResult>[] {
	return [
		{
			accessorKey: 'subject',
			header: 'Subject',
