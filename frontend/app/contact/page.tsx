					...
					<Card className="shadow-xl overflow-hidden">
						...
						<div className="grid md:grid-cols-2">
							<CardContent className="p-8 space-y-8 bg-card">
								<h3 className="text-2xl font-semibold text-primary border-b pb-3">
									Contact Information
								</h3>
								<div className="space-y-6 text-foreground/90">
									<div className="flex items-start gap-4">
										...
										<div>
											...
											<a
												href="mailto:support@mailthreader.com"
												className="text-muted-foreground hover:text-primary hover:underline"
											>
												support@mailthreader.com
											</a>
											<p className="text-sm text-muted-foreground/80">
												For support and general
												inquiries.
											</p>
										</div>
									</div>
							...
							<CardContent className="p-8 border-t md:border-t-0 md:border-l bg-card">
								<h3 className="text-2xl font-semibold text-primary mb-6 border-b pb-3">
									Send Us a Message
								</h3>
								<Form {...form}>
									<form
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input
															placeholder="e.g., Inquiry about Enterprise Plan"
															{...field}
														/>
													</FormControl>
													<FormMessage />
