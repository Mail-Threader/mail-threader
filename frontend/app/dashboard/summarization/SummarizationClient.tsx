...
export default function SummarizationClient({
	...
	const [selectedEmail, setSelectedEmail] = useState<AnalysisResult | null>(
		null,
	);
	const [isDetailsOpen, setIsDetailsOpen] = useState(false);
	const [rowAction, setRowAction] =
		useState<DataTableRowAction<AnalysisResult> | null>(null);

	const columns = useMemo(
		() =>
			getSummarizedEmailTableColumns({
				setRowAction,
				onViewDetails: (email: AnalysisResult) => {
		...
		<div className="space-y-6">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						View and explore the summarized email data with advanced
